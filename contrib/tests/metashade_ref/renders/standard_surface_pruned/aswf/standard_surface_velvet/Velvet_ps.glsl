...
void NG_metashade_standard_surface_coat0_metalness0_subsurface0_transmission0(float base, vec3 base_color, float diffuse_roughness, float specular, vec3 specular_color, float specular_roughness, float specular_IOR, float specular_anisotropy, float specular_rotation, float transmission_depth, vec3 transmission_scatter, float transmission_scatter_anisotropy, float transmission_dispersion, float sheen, vec3 sheen_color, float sheen_roughness, float thin_film_thickness, float thin_film_IOR, float emission, vec3 emission_color, vec3 opacity, vec3 normal, vec3 tangent, out surfaceshader out1)
{
    ...
    surfaceshader surface_ctor_out = surfaceshader(vec3(0.0),vec3(0.0));
    {
        ...
        // Add environment contribution
        {
            ...
            mx_metashade_standard_surface_coat0_metalness0_subsurface0_transmission0_bsdf(closureData, base, base_color, diffuse_roughness, specular, specular_color, specular_roughness, specular_IOR, specular_anisotropy, specular_rotation, sheen, sheen_color, sheen_roughness, thin_film_thickness, thin_film_IOR, normal, tangent, std_surface_bsdf);
...
void main()
{
    ...
    NG_metashade_standard_surface_coat0_metalness0_subsurface0_transmission0(SR_velvet_base, SR_velvet_base_color, SR_velvet_diffuse_roughness, SR_velvet_specular, SR_velvet_specular_color, SR_velvet_specular_roughness, SR_velvet_specular_IOR, SR_velvet_specular_anisotropy, SR_velvet_specular_rotation, SR_velvet_transmission_depth, SR_velvet_transmission_scatter, SR_velvet_transmission_scatter_anisotropy, SR_velvet_transmission_dispersion, SR_velvet_sheen, SR_velvet_sheen_color, SR_velvet_sheen_roughness, SR_velvet_thin_film_thickness, SR_velvet_thin_film_IOR, SR_velvet_emission, SR_velvet_emission_color, SR_velvet_opacity, geomprop_Nworld_out1, geomprop_Tworld_out1, SR_velvet_out);
