...
void main()
{
    ...
    NG_metashade_standard_surface_metalness0_sheen0_subsurface0_transmission0(SR_carpaint_base, SR_carpaint_base_color, SR_carpaint_diffuse_roughness, SR_carpaint_specular, SR_carpaint_specular_color, SR_carpaint_specular_roughness, SR_carpaint_specular_IOR, SR_carpaint_specular_anisotropy, SR_carpaint_specular_rotation, SR_carpaint_transmission_depth, SR_carpaint_transmission_scatter, SR_carpaint_transmission_scatter_anisotropy, SR_carpaint_transmission_dispersion, SR_carpaint_coat, SR_carpaint_coat_color, SR_carpaint_coat_roughness, SR_carpaint_coat_anisotropy, SR_carpaint_coat_rotation, SR_carpaint_coat_IOR, geomprop_Nworld_out1, SR_carpaint_coat_affect_color, SR_carpaint_coat_affect_roughness, SR_carpaint_thin_film_thickness, SR_carpaint_thin_film_IOR, SR_carpaint_emission, SR_carpaint_emission_color, SR_carpaint_opacity, geomprop_Nworld_out1, geomprop_Tworld_out1, SR_carpaint_out);
