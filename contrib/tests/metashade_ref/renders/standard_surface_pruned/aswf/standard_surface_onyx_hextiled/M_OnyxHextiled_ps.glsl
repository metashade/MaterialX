...
void main()
{
    ...
    NG_metashade_standard_surface_coat0_metalness0_sheen0_subsurface0_transmission0(N_StandardSurface_base, image_color_out_cm_out, N_StandardSurface_diffuse_roughness, N_StandardSurface_specular, N_StandardSurface_specular_color, image_roughness_float_out, N_StandardSurface_specular_IOR, N_StandardSurface_specular_anisotropy, N_StandardSurface_specular_rotation, N_StandardSurface_transmission_depth, N_StandardSurface_transmission_scatter, N_StandardSurface_transmission_scatter_anisotropy, N_StandardSurface_transmission_dispersion, N_StandardSurface_thin_film_thickness, N_StandardSurface_thin_film_IOR, N_StandardSurface_emission, N_StandardSurface_emission_color, N_StandardSurface_opacity, geomprop_Nworld_out1, geomprop_Tworld_out1, N_StandardSurface_out);
