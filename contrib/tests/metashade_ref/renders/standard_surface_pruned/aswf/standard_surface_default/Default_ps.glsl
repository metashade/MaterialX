...
void main()
{
    ...
    NG_metashade_standard_surface_coat0_metalness0_sheen0_subsurface0_transmission0(SR_default_base, SR_default_base_color, SR_default_diffuse_roughness, SR_default_specular, SR_default_specular_color, SR_default_specular_roughness, SR_default_specular_IOR, SR_default_specular_anisotropy, SR_default_specular_rotation, SR_default_transmission_depth, SR_default_transmission_scatter, SR_default_transmission_scatter_anisotropy, SR_default_transmission_dispersion, SR_default_thin_film_thickness, SR_default_thin_film_IOR, SR_default_emission, SR_default_emission_color, SR_default_opacity, geomprop_Nworld_out1, geomprop_Tworld_out1, SR_default_out);
