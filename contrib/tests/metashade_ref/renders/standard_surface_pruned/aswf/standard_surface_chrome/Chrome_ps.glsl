...
void main()
{
    ...
    NG_metashade_standard_surface_subsurface0(SR_chrome_base, SR_chrome_base_color, SR_chrome_diffuse_roughness, SR_chrome_metalness, SR_chrome_specular, SR_chrome_specular_color, SR_chrome_specular_roughness, SR_chrome_specular_IOR, SR_chrome_specular_anisotropy, SR_chrome_specular_rotation, SR_chrome_transmission, SR_chrome_transmission_color, SR_chrome_transmission_depth, SR_chrome_transmission_scatter, SR_chrome_transmission_scatter_anisotropy, SR_chrome_transmission_dispersion, SR_chrome_transmission_extra_roughness, SR_chrome_sheen, SR_chrome_sheen_color, SR_chrome_sheen_roughness, SR_chrome_coat, SR_chrome_coat_color, SR_chrome_coat_roughness, SR_chrome_coat_anisotropy, SR_chrome_coat_rotation, SR_chrome_coat_IOR, geomprop_Nworld_out1, SR_chrome_coat_affect_color, SR_chrome_coat_affect_roughness, SR_chrome_thin_film_thickness, SR_chrome_thin_film_IOR, SR_chrome_emission, SR_chrome_emission_color, SR_chrome_opacity, geomprop_Nworld_out1, geomprop_Tworld_out1, SR_chrome_out);
