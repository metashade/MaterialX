...
void main()
{
    ...
    NG_metashade_standard_surface_coat0_sheen0_transmission0(King_W_base, mtlximage7_out_cm_out, King_W_diffuse_roughness, mtlximage10_out, King_W_specular, King_W_specular_color, mtlximage11_out, King_W_specular_IOR, King_W_specular_anisotropy, King_W_specular_rotation, King_W_transmission_depth, King_W_transmission_scatter, King_W_transmission_scatter_anisotropy, King_W_transmission_dispersion, mtlximage8_out, mtlximage7_out_cm_out, mtlximage7_out_cm_out, King_W_subsurface_scale, King_W_subsurface_anisotropy, King_W_thin_film_thickness, King_W_thin_film_IOR, King_W_emission, King_W_emission_color, King_W_opacity, King_W_thin_walled, mtlxnormalmap11_out, geomprop_Tworld_out1, King_W_out);
