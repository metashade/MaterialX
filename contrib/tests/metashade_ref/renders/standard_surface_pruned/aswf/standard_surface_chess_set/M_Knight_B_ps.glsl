...
void main()
{
    ...
    NG_metashade_standard_surface_coat0_subsurface0(Knight_B_base, diffuse4_out_cm_out, Knight_B_diffuse_roughness, Knight_B_metalness, Knight_B_specular, Knight_B_specular_color, roughness4_out, Knight_B_specular_IOR, Knight_B_specular_anisotropy, Knight_B_specular_rotation, Knight_B_transmission, Knight_B_transmission_color, Knight_B_transmission_depth, Knight_B_transmission_scatter, Knight_B_transmission_scatter_anisotropy, Knight_B_transmission_dispersion, Knight_B_transmission_extra_roughness, Knight_B_sheen, Knight_B_sheen_color, Knight_B_sheen_roughness, Knight_B_thin_film_thickness, Knight_B_thin_film_IOR, Knight_B_emission, Knight_B_emission_color, Knight_B_opacity, mtlxnormalmap6_out, geomprop_Tworld_out1, Knight_B_out);
