...
void main()
{
    ...
    NG_metashade_standard_surface_coat0_subsurface0(Chessboard_base, mtlximage13_out_cm_out, Chessboard_diffuse_roughness, mtlximage16_out, Chessboard_specular, Chessboard_specular_color, mtlximage17_out, Chessboard_specular_IOR, Chessboard_specular_anisotropy, Chessboard_specular_rotation, Chessboard_transmission, Chessboard_transmission_color, Chessboard_transmission_depth, Chessboard_transmission_scatter, Chessboard_transmission_scatter_anisotropy, Chessboard_transmission_dispersion, Chessboard_transmission_extra_roughness, Chessboard_sheen, Chessboard_sheen_color, Chessboard_sheen_roughness, Chessboard_thin_film_thickness, Chessboard_thin_film_IOR, Chessboard_emission, Chessboard_emission_color, Chessboard_opacity, mtlxnormalmap12_out, geomprop_Tworld_out1, Chessboard_out);
