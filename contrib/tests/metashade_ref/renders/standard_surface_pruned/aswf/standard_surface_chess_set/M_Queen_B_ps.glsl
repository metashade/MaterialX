...
void NG_metashade_standard_surface_coat0_sheen0_transmission0(float base, vec3 base_color, float diffuse_roughness, float metalness, float specular, vec3 specular_color, float specular_roughness, float specular_IOR, float specular_anisotropy, float specular_rotation, float transmission_depth, vec3 transmission_scatter, float transmission_scatter_anisotropy, float transmission_dispersion, float subsurface, vec3 subsurface_color, vec3 subsurface_radius, float subsurface_scale, float subsurface_anisotropy, float thin_film_thickness, float thin_film_IOR, float emission, vec3 emission_color, vec3 opacity, bool thin_walled, vec3 normal, vec3 tangent, out surfaceshader out1)
{
    ...
    surfaceshader surface_ctor_out = surfaceshader(vec3(0.0),vec3(0.0));
    {
        ...
        // Add environment contribution
        {
            ...
            mx_metashade_standard_surface_coat0_sheen0_transmission0_bsdf(closureData, base, base_color, diffuse_roughness, metalness, specular, specular_color, specular_roughness, specular_IOR, specular_anisotropy, specular_rotation, subsurface, subsurface_color, subsurface_radius, subsurface_scale, subsurface_anisotropy, thin_film_thickness, thin_film_IOR, thin_walled, normal, tangent, std_surface_bsdf);
...
void main()
{
    ...
    NG_metashade_standard_surface_coat0_sheen0_transmission0(Queen_B_base, diffuse_out_cm_out, Queen_B_diffuse_roughness, metallic_out, Queen_B_specular, Queen_B_specular_color, roughness_out, Queen_B_specular_IOR, Queen_B_specular_anisotropy, Queen_B_specular_rotation, Queen_B_transmission_depth, Queen_B_transmission_scatter, Queen_B_transmission_scatter_anisotropy, Queen_B_transmission_dispersion, sss_out, diffuse_out_cm_out, diffuse_out_cm_out, Queen_B_subsurface_scale, Queen_B_subsurface_anisotropy, Queen_B_thin_film_thickness, Queen_B_thin_film_IOR, Queen_B_emission, Queen_B_emission_color, Queen_B_opacity, Queen_B_thin_walled, mtlxnormalmap2_out, geomprop_Tworld_out1, Queen_B_out);
