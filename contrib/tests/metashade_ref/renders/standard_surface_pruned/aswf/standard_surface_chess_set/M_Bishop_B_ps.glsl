...
void main()
{
    ...
    NG_metashade_standard_surface_coat0_sheen0_subsurface0_transmission0(Bishop_B_base, diffuse2_out_cm_out, Bishop_B_diffuse_roughness, metallic2_out, Bishop_B_specular, Bishop_B_specular_color, roughness2_out, Bishop_B_specular_IOR, Bishop_B_specular_anisotropy, Bishop_B_specular_rotation, Bishop_B_transmission_depth, Bishop_B_transmission_scatter, Bishop_B_transmission_scatter_anisotropy, Bishop_B_transmission_dispersion, Bishop_B_thin_film_thickness, Bishop_B_thin_film_IOR, Bishop_B_emission, Bishop_B_emission_color, Bishop_B_opacity, mtlxnormalmap4_out, geomprop_Tworld_out1, Bishop_B_out);
