...
void main()
{
    ...
    NG_metashade_standard_surface_coat0_metalness0_sheen0_subsurface0_transmission0(Knight_W_base, diffuse5_out_cm_out, Knight_W_diffuse_roughness, Knight_W_specular, Knight_W_specular_color, roughness5_out, Knight_W_specular_IOR, Knight_W_specular_anisotropy, Knight_W_specular_rotation, Knight_W_transmission_depth, Knight_W_transmission_scatter, Knight_W_transmission_scatter_anisotropy, Knight_W_transmission_dispersion, Knight_W_thin_film_thickness, Knight_W_thin_film_IOR, Knight_W_emission, Knight_W_emission_color, Knight_W_opacity, mtlxnormalmap7_out, geomprop_Tworld_out1, Knight_W_out);
