...
void main()
{
    ...
    NG_metashade_standard_surface_coat0_subsurface0(Bishop_W_base, diffuse3_out_cm_out, Bishop_W_diffuse_roughness, metallic3_out, Bishop_W_specular, Bishop_W_specular_color, roughness3_out, Bishop_W_specular_IOR, Bishop_W_specular_anisotropy, Bishop_W_specular_rotation, Bishop_W_transmission, Bishop_W_transmission_color, Bishop_W_transmission_depth, Bishop_W_transmission_scatter, Bishop_W_transmission_scatter_anisotropy, Bishop_W_transmission_dispersion, Bishop_W_transmission_extra_roughness, Bishop_W_sheen, Bishop_W_sheen_color, Bishop_W_sheen_roughness, Bishop_W_thin_film_thickness, Bishop_W_thin_film_IOR, Bishop_W_emission, Bishop_W_emission_color, Bishop_W_opacity, mtlxnormalmap5_out, geomprop_Tworld_out1, Bishop_W_out);
