...
void main()
{
    ...
    NG_metashade_standard_surface_coat0_sheen0(King_B_base, mtlximage1_out_cm_out, King_B_diffuse_roughness, mtlximage2_out, King_B_specular, King_B_specular_color, mtlximage4_out, King_B_specular_IOR, King_B_specular_anisotropy, King_B_specular_rotation, King_B_transmission, King_B_transmission_color, King_B_transmission_depth, King_B_transmission_scatter, King_B_transmission_scatter_anisotropy, King_B_transmission_dispersion, King_B_transmission_extra_roughness, mtlximage3_out, mtlximage1_out_cm_out, mtlximage1_out_cm_out, King_B_subsurface_scale, King_B_subsurface_anisotropy, King_B_thin_film_thickness, King_B_thin_film_IOR, King_B_emission, King_B_emission_color, King_B_opacity, King_B_thin_walled, mtlxnormalmap1_out, geomprop_Tworld_out1, King_B_out);
