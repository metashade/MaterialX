...
void main()
{
    ...
    NG_metashade_standard_surface_coat0_metalness0_sheen0_subsurface0(Pawn_Top_B_base, Pawn_Top_B_base_color, Pawn_Top_B_diffuse_roughness, Pawn_Top_B_specular, Pawn_Top_B_specular_color, mtlximage19_out, Pawn_Top_B_specular_IOR, Pawn_Top_B_specular_anisotropy, Pawn_Top_B_specular_rotation, Pawn_Top_B_transmission, Pawn_Top_B_transmission_color, Pawn_Top_B_transmission_depth, Pawn_Top_B_transmission_scatter, Pawn_Top_B_transmission_scatter_anisotropy, Pawn_Top_B_transmission_dispersion, Pawn_Top_B_transmission_extra_roughness, Pawn_Top_B_thin_film_thickness, Pawn_Top_B_thin_film_IOR, Pawn_Top_B_emission, Pawn_Top_B_emission_color, Pawn_Top_B_opacity, mtlxnormalmap14_out, geomprop_Tworld_out1, Pawn_Top_B_out);
