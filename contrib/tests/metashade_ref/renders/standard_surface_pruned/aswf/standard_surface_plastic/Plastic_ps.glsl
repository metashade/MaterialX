...
void NG_metashade_standard_surface_coat0_sheen0_subsurface0(float base, vec3 base_color, float diffuse_roughness, float metalness, float specular, vec3 specular_color, float specular_roughness, float specular_IOR, float specular_anisotropy, float specular_rotation, float transmission, vec3 transmission_color, float transmission_depth, vec3 transmission_scatter, float transmission_scatter_anisotropy, float transmission_dispersion, float transmission_extra_roughness, float thin_film_thickness, float thin_film_IOR, float emission, vec3 emission_color, vec3 opacity, vec3 normal, vec3 tangent, out surfaceshader out1)
{
...
void main()
{
    ...
    NG_metashade_standard_surface_coat0_sheen0_subsurface0(SR_plastic_base, SR_plastic_base_color, SR_plastic_diffuse_roughness, SR_plastic_metalness, SR_plastic_specular, SR_plastic_specular_color, SR_plastic_specular_roughness, SR_plastic_specular_IOR, SR_plastic_specular_anisotropy, SR_plastic_specular_rotation, SR_plastic_transmission, SR_plastic_transmission_color, SR_plastic_transmission_depth, SR_plastic_transmission_scatter, SR_plastic_transmission_scatter_anisotropy, SR_plastic_transmission_dispersion, SR_plastic_transmission_extra_roughness, SR_plastic_thin_film_thickness, SR_plastic_thin_film_IOR, SR_plastic_emission, SR_plastic_emission_color, SR_plastic_opacity, geomprop_Nworld_out1, geomprop_Tworld_out1, SR_plastic_out);
