...
void main()
{
    ...
    NG_metashade_standard_surface_coat0_subsurface0(SR_gold_base, SR_gold_base_color, SR_gold_diffuse_roughness, SR_gold_metalness, SR_gold_specular, SR_gold_specular_color, SR_gold_specular_roughness, SR_gold_specular_IOR, SR_gold_specular_anisotropy, SR_gold_specular_rotation, SR_gold_transmission, SR_gold_transmission_color, SR_gold_transmission_depth, SR_gold_transmission_scatter, SR_gold_transmission_scatter_anisotropy, SR_gold_transmission_dispersion, SR_gold_transmission_extra_roughness, SR_gold_sheen, SR_gold_sheen_color, SR_gold_sheen_roughness, SR_gold_thin_film_thickness, SR_gold_thin_film_IOR, SR_gold_emission, SR_gold_emission_color, SR_gold_opacity, geomprop_Nworld_out1, geomprop_Tworld_out1, SR_gold_out);
