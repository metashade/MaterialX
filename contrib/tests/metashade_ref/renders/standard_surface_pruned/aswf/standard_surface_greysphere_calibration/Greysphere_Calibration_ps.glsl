...
void main()
{
    ...
    NG_metashade_standard_surface_coat0_metalness0_sheen0_subsurface0_transmission0(SR_Greysphere_Calibration_base, image1_out_cm_out, SR_Greysphere_Calibration_diffuse_roughness, SR_Greysphere_Calibration_specular, SR_Greysphere_Calibration_specular_color, SR_Greysphere_Calibration_specular_roughness, SR_Greysphere_Calibration_specular_IOR, SR_Greysphere_Calibration_specular_anisotropy, SR_Greysphere_Calibration_specular_rotation, SR_Greysphere_Calibration_transmission_depth, SR_Greysphere_Calibration_transmission_scatter, SR_Greysphere_Calibration_transmission_scatter_anisotropy, SR_Greysphere_Calibration_transmission_dispersion, SR_Greysphere_Calibration_thin_film_thickness, SR_Greysphere_Calibration_thin_film_IOR, SR_Greysphere_Calibration_emission, SR_Greysphere_Calibration_emission_color, SR_Greysphere_Calibration_opacity, geomprop_Nworld_out1, geomprop_Tworld_out1, SR_Greysphere_Calibration_out);
