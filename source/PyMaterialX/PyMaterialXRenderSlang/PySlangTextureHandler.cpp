...
{
    // Note: SlangTextureHandler::create() is not exposed because it requires
    // SlangContextPtr, an internal type not bound to Python.  Construct via
    // SlangRenderer::createImageHandler() instead.
